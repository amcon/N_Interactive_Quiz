$(function() {
  ...
  function appendResult() {
    if (completedCounter >= 6 && max === 1) {
      ...
      $('.result-description').append("<p>You are a world warrior! You’ve watched Al Gore’s documentary and you are on the front lines of fighting against that inconvenient truth. <br>The e-Bio-Fuel Cell is the world's first Solid-Oxide Fuel Cell powered prototype vehicle that runs on bio-ethanol fuel. The e-Bio-Fuel Cell offers eco-friendly transportation and creates opportunities for regional energy production…all the while supporting existing infrastructure. What does that mean? That your carbon footprint is smaller than most people. Thanks for the changing the world, now hit the road! <br>Click <a href='#'>here</a> to learn more.</p>");
      $('#share-results-twitter').click(function() {
      ...
      $('.result-description').append("<p>For you, it’s family and friends first. The Nissan X-Trail is made just for you and your adventures. <br>A hybrid SUV that will keep you on the go, while being surrounded by the people you care about. Not to mention, the X-Trail is fully equipped with all the Nissan Intelligent Mobility safety features to give you peace of mind when you are sending your kids to school or driving to your next ski-trip in the mountains. We know it’s hard to do-it-all, but the X-Trail makes it a little easier. Ready with your next adventure? <br>Click <a href='#'>here</a> to learn more.</p>");
      $('#share-results-twitter').click(function() {
