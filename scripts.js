$(function() {
  ...
  function appendResult() {
    if (completedCounter >= 6 && max === 1 && quizCompleted === false) {
      ...
      $('.result-description').append("<p>You are a world warrior! You’ve watched Al Gore’s documentary and you are on the front lines of fighting against that inconvenient truth. <br>The e-Bio-Fuel Cell is the world's first Solid-Oxide Fuel Cell powered prototype vehicle that runs on bio-ethanol fuel. The e-Bio-Fuel Cell offers eco-friendly transportation and creates opportunities for regional energy production…all the while supporting existing infrastructure. What does that mean? That your carbon footprint is smaller than most people. Thanks for the changing the world, now hit the road! <br>Click <a target='_blank' href='https://newsroom.nissan-global.com/releases/release-8e6125526a1bba291bd020d4cc027c38-nissan-unveils-worlds-first-solid-oxide-fuel-cell-vehicle?query=Sofc'>here</a> to learn more.</p>");
      $('#share-results-twitter').click(function() {
        window.open("https://twitter.com/intent/tweet?url=https://amcon.github.io/N_Interactive_Quiz&text=Do this quiz! I got the NISSAN e-Bio-Fuel Cell: ");
      });
      $('#share-results-facebook').click(function() {
        FB.ui({
          method: 'feed',
      ...
      $('.result-description').append("<p>For you, it’s family and friends first. The Nissan X-Trail is made just for you and your adventures. <br>A hybrid SUV that will keep you on the go, while being surrounded by the people you care about. Not to mention, the X-Trail is fully equipped with all the Nissan Intelligent Mobility safety features to give you peace of mind when you are sending your kids to school or driving to your next ski-trip in the mountains. We know it’s hard to do-it-all, but the X-Trail makes it a little easier. Ready with your next adventure? <br>Click <a target='_blank' href='https://newsroom.nissan-global.com/channels/content/channel-1466'>here</a> to learn more.</p>");
      $('#share-results-twitter').click(function() {
      ...
      $('.result-description').append("<p>You’re a different breed than most exotic sports car drivers! You want the best of both worlds, you care about speed but also emissions. Who’d have thought you could have it all? <br>The Nissan BladeGlider is a driving prototype that combines zero-emissions with high-performance in a revolutionary sports car design. Its innovative exterior design allows you to test the limits of speed and acceleration, providing the exhilaration of an open-topped race car with a safety of a coupe. It's the electric vehicle for car lovers! So what do you say Mr. Bond, how do you like your new ride? <br>Click <a target='_blank' href='https://newsroom.nissan-global.com/releases/release-8e6125526a1bba291bd020d4cc01e9d1-nissan-bladeglider-brings-cutting-edge-intelligent-mobility-to-life?query=Bladeglider&sortOrder=Relevance'>here</a> to learn more.</p>");
      $('#share-results-twitter').click(function() {
